...
function sanitizeLine(text, fallback) {
...
function buildQuestionFallbackAnswer(input, targetDate) {
...
async function callGemini(prompt, runtime) {
...
async function getCurrentWeatherInsight(input) {
...
function getFallbackForecastDescriptions(daily) {
    return daily.weather_code.map((code) => fallbackDescription(code));
}
async function getForecastWeatherInsight(input) {
...
async function getWeatherQuestionInsight(input) {
